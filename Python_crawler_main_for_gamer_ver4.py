...
if open_googlesheets_status == True:
    ...
    if basic_status == True:
            ...
            try: #寫入試算表1："人氣紀錄"
                ...
                if str(datetime.strptime(worksheet.get_value("A{}".format(gamer_writesit))+worksheet.get_value("C{}".format(gamer_writesit)), "%Y年%m月%d日")) == str(gamer_dates[6]): #如果試算表上所寫的「昨天的日期」等於「ad_year+date_yesterday」
                    ...
                    if int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]) == 12:
                        if (gamer_writesit > (sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 3)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 4)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 5)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 6)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 7)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 8)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 9)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 10)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 11)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 12)-1)) and (int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[1].split("日")[0]) == month_lastday):
                            worksheet.update_values("H{}".format(gamer_writesit-15), [["本年總和"], ["=SUM($F{}:$F{})".format(gamer_writesit+1-(sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 3)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 4)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 5)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 6)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 7)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 8)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 9)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 10)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 11)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 12)), gamer_writesit)], ["本年日平均"], ["=AVERAGE(F{}:F{})".format(gamer_writesit+1-(sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 3)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 4)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 5)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 6)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 7)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 8)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 9)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 10)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 11)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 12)), gamer_writesit)]]) #寫入本年總和和日平均
                        elif (gamer_writesit < (sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 3)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 4)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 5)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 6)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 7)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 8)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 9)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 10)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 11)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), 12)-1)) and (int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[1].split("日")[0]) == month_lastday):
                            start_point = 3
                            while worksheet.get_value("D{}".format(start_point)) == "✕": #一直運作直到得到的字串為「完全空白」
                                start_point = start_point+1
                            if start_point < 18:
                                worksheet.update_values("H3", [["本年總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本年日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]]) #寫入本年總和和日平均
                            else:
                                worksheet.update_values("H{}".format(gamer_writesit-15), [["本年總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本年日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]]) #寫入本年總和和日平均
                    if int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]) in [6, 12]:
                        ...
                        elif (gamer_writesit < (sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-5)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-4)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-3)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]))-1)) and (int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[1].split("日")[0]) == month_lastday):
                            start_point = 3
                            while worksheet.get_value("D{}".format(start_point)) == "✕": #一直運作直到得到的字串為「完全空白」
                                start_point = start_point+1
                            if start_point < 14 and int(date_yesterday.split("月")[0]) == 12:
                                worksheet.update_values("H7", [["本半年總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本半年日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                            elif start_point < 14 and int(date_yesterday.split("月")[0]) == 6:
                                worksheet.update_values("H3", [["本半年總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本半年日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                            else:
                                worksheet.update_values("H{}".format(gamer_writesit-11), [["本半年總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本半年日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                    if int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]) in [3, 6, 9, 12]:
                        ...
                        elif (gamer_writesit < (sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-2)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0])-1)+sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]))-1)) and (int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[1].split("日")[0]) == month_lastday):
                            start_point = 3
                            while worksheet.get_value("D{}".format(start_point)) == "✕": #一直運作直到得到的字串為「完全空白」
                                start_point = start_point+1
                            if start_point < 10 and int(date_yesterday.split("月")[0]) == 12:
                                worksheet.update_values("H11", [["本季總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本季日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                            elif start_point < 10 and int(date_yesterday.split("月")[0]) == 6:
                                worksheet.update_values("H7", [["本季總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本季日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                            elif start_point < 10 and (int(date_yesterday.split("月")[0]) in [3, 9]):
                                worksheet.update_values("H3", [["本季總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本季日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                            else:
                                worksheet.update_values("H{}".format(gamer_writesit-7), [["本季總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本季日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                    ...
                    elif (gamer_writesit < (sub_program.lastday_of_month(int(ad_year_yesterday.split("年")[0]), int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[0]))-1)) and (int(worksheet.get_value("C{}".format(gamer_writesit)).split("月")[1].split("日")[0]) == month_lastday):
                        start_point = 3
                        while worksheet.get_value("D{}".format(start_point)) == "✕": #一直運作直到得到的字串為「完全空白」
                            start_point = start_point+1
                        if start_point < 6 and int(date_yesterday.split("月")[0]) == 12:
                            worksheet.update_values("H15", [["本月總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本月日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                        elif start_point < 6 and int(date_yesterday.split("月")[0]) == 6:
                            worksheet.update_values("H11", [["本月總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本月日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                        elif start_point < 6 and (int(date_yesterday.split("月")[0]) in [3, 9]):
                            worksheet.update_values("H7", [["本月總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本月日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                        elif start_point < 6 and (int(date_yesterday.split("月")[0]) in [1, 2, 4, 5, 7, 8, 10, 11]):
                            worksheet.update_values("H3", [["本月總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本月日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                        else:
                            worksheet.update_values("H{}".format(gamer_writesit-3), [["本月總和"], ["=SUM($F{}:$F{})".format(start_point, gamer_writesit)], ["本月日平均"], ["=AVERAGE(F{}:F{})".format(start_point, gamer_writesit)]])
                worksheet.update_values("H3", [["至今總人氣數"], ["=394+SUM($F$3:$F{})".format(gamer_writesit)]]) #寫入巴哈總人氣數
                worksheet.update_values("H55", [["至今總人氣數"], ["=394+SUM($F$3:$F{})".format(gamer_writesit)]]) #寫入巴哈總人氣數
        ...
        while code_section_6C_status == "✕" and time_6C < 3:
            try:
                if code_section_3_status == "〇":
                    for l in range(3, (gamer_follower_number_last+4)):
                ...
                if code_section_4_status == "〇":
                    for m in range(3, (gamer_friend_number_last+4)):
